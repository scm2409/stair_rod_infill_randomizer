...
app = typer.Typer(
    help="Railing Infill Generator - Desktop application for generating rod arrangements"
)
...
def main(
    ...
    config_path: Path = typer.Option(Path("conf"), "--config-path", help="Custom config directory"),
) -> None:
    """
