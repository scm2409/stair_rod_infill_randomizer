...
def create_closed_rectangular_frame(width: float = 100.0, height: float = 100.0, weight_kg_m: float = 0.5) -> list[Rod]:
    """Helper to create a closed rectangular frame."""
    return [
        Rod(geometry=LineString([(0, 0), (0, height)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=weight_kg_m, layer=0),
        Rod(geometry=LineString([(0, height), (width, height)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=weight_kg_m, layer=0),
        Rod(geometry=LineString([(width, height), (width, 0)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=weight_kg_m, layer=0),
        Rod(geometry=LineString([(width, 0), (0, 0)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=weight_kg_m, layer=0),
    ]
...
class TestRailingFrameImmutability:
    ...
    def test_cannot_modify_rods(self):
        ...
        rods = [
            ...
            Rod(geometry=LineString([(0, 100), (100, 100)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=0.5, layer=0),
            Rod(geometry=LineString([(100, 100), (100, 0)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=0.5, layer=0),
            Rod(geometry=LineString([(100, 0), (0, 0)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=0.5, layer=0),
        ]
        frame = RailingFrame(rods=rods)
...
class TestRailingFrameComputedFields:
    ...
    def test_total_weight_kg_different_weights(self):
        ...
        rods = [
            Rod(geometry=LineString([(0, 0), (0, 100)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=0.5, layer=0),
            Rod(geometry=LineString([(0, 100), (100, 100)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=1.0, layer=0),
            Rod(geometry=LineString([(100, 100), (100, 0)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=0.5, layer=0),
            Rod(geometry=LineString([(100, 0), (0, 0)]), start_cut_angle_deg=0.0, end_cut_angle_deg=0.0, weight_kg_m=1.0, layer=0),
        ]
        frame = RailingFrame(rods=rods)
